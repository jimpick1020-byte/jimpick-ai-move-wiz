...
export const ITEM_CATALOG: {
  ...
  { id: "sofa1", name: "소파(1인)", cat: "가구", sub: "거실", emoji: "🛋️", extra: 10000 },
  ...
  { id: "grandclock", name: "괘종시계", cat: "가구", sub: "거실", emoji: "🕰️" },
  { id: "bedss", name: "침대(슈퍼싱글)", cat: "가구", sub: "침실", emoji: "🛏️", extra: 20000 },
  { id: "beddouble", name: "침대(더블)", cat: "가구", sub: "침실", emoji: "🛏️", extra: 20000 },
  { id: "bedking", name: "침대(킹)", cat: "가구", sub: "침실", emoji: "🛏️", extra: 30000 },
  { id: "loftbed", name: "벙커침대(책상형)", cat: "가구", sub: "침실", emoji: "🛏️", extra: 30000 },
  ...
  { id: "projectiontv", name: "프로젝션 TV", cat: "가전", sub: "영상·음향", emoji: "📺" },
  { id: "subwoofer", name: "서브우퍼", cat: "가전", sub: "영상·음향", emoji: "🔊" },
  { id: "audioset", name: "오디오 세트", cat: "가전", sub: "영상·음향", emoji: "🔊" },
  { id: "organ", name: "전자오르간", cat: "가전", sub: "영상·음향", emoji: "🎹" },
  ...
  { id: "spinbike", name: "스피닝 바이크", cat: "특수", sub: "운동", emoji: "🚴", extra: 10000 },
  { id: "squatrack", name: "스쿼트랙", cat: "특수", sub: "운동", emoji: "🏋️", extra: 20000 },
  { id: "benchpress", name: "벤치프레스", cat: "특수", sub: "운동", emoji: "🏋️", extra: 20000 },
  { id: "dumbbell", name: "덤벨 세트", cat: "특수", sub: "운동", emoji: "🏋️" },
  { id: "inversion", name: "거꾸리(인버전)", cat: "특수", sub: "운동", emoji: "🤸" },
  { id: "pilates", name: "필라테스 리포머", cat: "특수", sub: "운동", emoji: "🧘", extra: 20000 },
  { id: "massagebed", name: "안마베드", cat: "특수", sub: "운동", emoji: "💆", extra: 20000 },
  { id: "sauna", name: "사우나", cat: "특수", sub: "특수운반", emoji: "🧖", extra: 30000 },
  { id: "airhockey", name: "에어하키", cat: "특수", sub: "취미", emoji: "🏒", extra: 20000 },
  { id: "foosball", name: "풋볼 테이블", cat: "특수", sub: "취미", emoji: "⚽", extra: 10000 },
  { id: "wetvac", name: "건습식 청소기", cat: "가전", sub: "사무·기타", emoji: "🧹" },
  { id: "oilheater", name: "오일히터", cat: "가전", sub: "냉난방", emoji: "🔥" },
  { id: "steamcleaner", name: "스팀청소기", cat: "가전", sub: "사무·기타", emoji: "🧹" },
  { id: "disposer", name: "음식물처리기", cat: "주방", sub: "주방가전", emoji: "🗑️" },
