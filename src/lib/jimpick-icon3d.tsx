...
export const ICON3D: Record<string, string> = {
  ...
  // ── 새로 추가한 품목 ──
  cubeshelf: `${BASE}/furniture/cube-shelf.webp`,
  cornershelf: `${BASE}/furniture/corner-shelf.webp`,
  magazinerack: `${BASE}/furniture/magazine-rack.webp`,
  recordcabinet: `${BASE}/furniture/record-cabinet.webp`,
  bathcabinet: `${BASE}/furniture/bathroom-cabinet.webp`,
  washbasin: `${BASE}/furniture/washbasin.webp`,
  kitchencart: `${BASE}/furniture/kitchen-cart.webp`,
  rollingdrawer: `${BASE}/furniture/rolling-drawer.webp`,
  storagebench: `${BASE}/furniture/storage-bench.webp`,
  foldwardrobe: `${BASE}/furniture/folding-wardrobe.webp`,
  nestingtable: `${BASE}/furniture/nesting-table.webp`,
  bedtable: `${BASE}/furniture/bed-tray-table.webp`,
  kneelchair: `${BASE}/furniture/kneeling-chair.webp`,
  pianobench: `${BASE}/furniture/piano-bench.webp`,
  roundstool: `${BASE}/furniture/round-stool.webp`,
  umbrellastand: `${BASE}/living/umbrella-stand.webp`,
  plantstand: `${BASE}/living/plant-stand.webp`,
  electricblanket: `${BASE}/living/electric-blanket.webp`,
  washerstand: `${BASE}/appliances/washer-pedestal.webp`,
  steamer: `${BASE}/appliances/garment-steamer.webp`,
  iron: `${BASE}/appliances/iron.webp`,
  towerfan: `${BASE}/appliances/tower-fan.webp`,
  ceilingfan: `${BASE}/appliances/ceiling-fan-2.webp`,
  windowac: `${BASE}/appliances/window-ac.webp`,
  portableac: `${BASE}/appliances/portable-ac.webp`,
  breadmaker: `${BASE}/appliances/bread-maker.webp`,
  icemaker: `${BASE}/appliances/ice-maker.webp`,
  juicer: `${BASE}/kitchen/juicer.webp`,
  handmixer: `${BASE}/kitchen/hand-mixer.webp`,
  sandwichgrill: `${BASE}/kitchen/sandwich-grill.webp`,
  highchair: `${BASE}/special/high-chair.webp`,
  changingtable: `${BASE}/special/changing-table.webp`,
  playpen: `${BASE}/special/playpen.webp`,
  safetygate: `${BASE}/special/safety-gate.webp`,
  toybox: `${BASE}/special/toy-box.webp`,
  kidsslide: `${BASE}/special/kids-slide.webp`,
  doghouse: `${BASE}/special/dog-house-2.webp`,
  petstroller: `${BASE}/special/pet-stroller.webp`,
  birdcage: `${BASE}/special/bird-cage.webp`,
  reptiletank: `${BASE}/special/reptile-tank.webp`,
  bbqgrill: `${BASE}/special/bbq-grill.webp`,
  parasol: `${BASE}/special/parasol.webp`,
  campingtable: `${BASE}/special/camping-table.webp`,
  bikestand: `${BASE}/special/bike-stand.webp`,
  surfboard: `${BASE}/special/surfboard.webp`,
  kayak: `${BASE}/special/kayak.webp`,
  sleepingbag: `${BASE}/special/sleeping-bag.webp`,
  fishing: `${BASE}/special/fishing-gear.webp`,
  wheelchair: `${BASE}/special/wheelchair-2.webp`,
  hospitalbed: `${BASE}/special/hospital-bed-2.webp`,
  massagetable: `${BASE}/special/massage-table.webp`,
  turntable: `${BASE}/special/turntable-2.webp`,
  guitar: `${BASE}/special/acoustic-guitar.webp`,
  cello: `${BASE}/special/cello-case.webp`,
  drumset: `${BASE}/special/drum-kit.webp`,
  karaoke: `${BASE}/special/karaoke-machine.webp`,
  camera: `${BASE}/special/camera-gear.webp`,
  telescope: `${BASE}/special/telescope.webp`,
  dressform: `${BASE}/special/dress-form.webp`,
  easel: `${BASE}/special/easel.webp`,
  potterywheel: `${BASE}/special/pottery-wheel.webp`,
  yogamat: `${BASE}/special/yoga-mat.webp`,
  rowing: `${BASE}/special/rowing-machine.webp`,
...
const BLUE = "/assets/items-3d/jimpick-blue";
Object.assign(ICON3D, {
  fridge: `${BLUE}/fridge.png`,
  sidefridge: `${BLUE}/sidefridge.png`,
  frenchfridge: `${BLUE}/frenchfridge.png`,
  bizfridge: `${BLUE}/bizfridge.png`,
  freezer: `${BLUE}/freezer.png`,
  kimchi: `${BLUE}/kimchi.png`,
  drumwasher: `${BLUE}/drumwasher.png`,
  washer: `${BLUE}/washer.png`,
  dryer: `${BLUE}/dryer.png`,
  washtower: `${BLUE}/washtower.png`,
  styler: `${BLUE}/styler.png`,
  dishwasher: `${BLUE}/dishwasher.png`,
  electricrange: `${BLUE}/electricrange.png`,
  induction: `${BLUE}/induction.png`,
  gasrange: `${BLUE}/gasrange.png`,
  aircon: `${BLUE}/aircon.png`,
  wallaircon: `${BLUE}/wallaircon.png`,
  ceilingac: `${BLUE}/ceilingac.png`,
  airpurifier: `${BLUE}/airpurifier.png`,
  waterpurifier: `${BLUE}/waterpurifier.png`,
  sofa1: `${BLUE}/sofa1.png`,
  sofa2: `${BLUE}/sofa2.png`,
  sofa: `${BLUE}/sofa.png`,
  sofabig: `${BLUE}/sofabig.png`,
  cornersofa: `${BLUE}/cornersofa.png`,
  recliner: `${BLUE}/recliner.png`,
  massagechair: `${BLUE}/massagechair.png`,
  sofabed: `${BLUE}/sofabed.png`,
  teatable: `${BLUE}/teatable.png`,
  marblecoffee: `${BLUE}/marblecoffee.png`,
  tvstand: `${BLUE}/tvstand.png`,
  tvwall: `${BLUE}/tvwall.png`,
  displaycase: `${BLUE}/displaycase.png`,
  glasscabinet: `${BLUE}/glasscabinet.png`,
  shelf: `${BLUE}/shelf.png`,
  cubeshelf: `${BLUE}/cubeshelf.png`,
  sideboard: `${BLUE}/sideboard.png`,
  shoerack: `${BLUE}/shoerack.png`,
  grandclock: `${BLUE}/grandclock.png`,
  standlight: `${BLUE}/standlight.png`,
  bed: `${BLUE}/bed.png`,
  bedss: `${BLUE}/bedss.png`,
  beddouble: `${BLUE}/beddouble.png`,
  bedq: `${BLUE}/bedq.png`,
  bedking: `${BLUE}/bedking.png`,
  bunkbed: `${BLUE}/bunkbed.png`,
  loftbed: `${BLUE}/loftbed.png`,
  hospitalbed: `${BLUE}/hospitalbed.png`,
  storagebed: `${BLUE}/storagebed.png`,
  canopybed: `${BLUE}/canopybed.png`,
  wardrobe: `${BLUE}/wardrobe.png`,
  wardrobe4: `${BLUE}/wardrobe4.png`,
  slidewardrobe: `${BLUE}/slidewardrobe.png`,
  builtin: `${BLUE}/builtin.png`,
  drawer: `${BLUE}/drawer.png`,
  chestdrawer: `${BLUE}/chestdrawer.png`,
  vanity: `${BLUE}/vanity.png`,
  nightstand: `${BLUE}/nightstand.png`,
  mattress: `${BLUE}/mattress.png`,
  hanger: `${BLUE}/hanger.png`,
  table: `${BLUE}/table.png`,
  table6: `${BLUE}/table6.png`,
  table8: `${BLUE}/table8.png`,
  roundtable: `${BLUE}/roundtable.png`,
  marbletable: `${BLUE}/marbletable.png`,
  extendtable: `${BLUE}/extendtable.png`,
  island: `${BLUE}/island.png`,
  kitchenisland: `${BLUE}/kitchenisland.png`,
  pantry: `${BLUE}/pantry.png`,
  kitchencabinet: `${BLUE}/kitchencabinet.png`,
  kitchensideboard: `${BLUE}/kitchensideboard.png`,
  dishcabinet: `${BLUE}/dishcabinet.png`,
  ricebin: `${BLUE}/ricebin.png`,
  worktable: `${BLUE}/worktable.png`,
  cafetable: `${BLUE}/cafetable.png`,
  homebar: `${BLUE}/homebar.png`,
  winecellar: `${BLUE}/winecellar.png`,
  waste: `${BLUE}/waste.png`,
  microwavestand: `${BLUE}/microwavestand.png`,
  foldtable: `${BLUE}/foldtable.png`,
});

// 2차 세트 (전자·오피스·헬스/게임·소형가전·수납/생활·업소용) 교체 + 신규
Object.assign(ICON3D, {
  tv: `${BLUE}/tv.png`,
  bigtv: `${BLUE}/bigtv.png`,
  curvedtv: `${BLUE}/curvedtv.png`,
  walltv: `${BLUE}/walltv.png`,
  projectiontv: `${BLUE}/projectiontv.png`,
  subwoofer: `${BLUE}/subwoofer.png`,
  audioset: `${BLUE}/audioset.png`,
  speaker: `${BLUE}/speaker.png`,
  digitalpiano: `${BLUE}/digitalpiano.png`,
  piano: `${BLUE}/piano.png`,
  grandpiano: `${BLUE}/grandpiano.png`,
  organ: `${BLUE}/organ.png`,
  karaoke: `${BLUE}/karaoke.png`,
  arcade: `${BLUE}/arcade.png`,
  pc: `${BLUE}/pc.png`,
  printer: `${BLUE}/printer.png`,
  projector: `${BLUE}/projector.png`,
  execdesk: `${BLUE}/execdesk.png`,
  ldesk: `${BLUE}/ldesk.png`,
  desk: `${BLUE}/desk.png`,
  workstation: `${BLUE}/workstation.png`,
  conferencetable: `${BLUE}/conferencetable.png`,
  standdesk: `${BLUE}/standdesk.png`,
  reception: `${BLUE}/reception.png`,
  officechair: `${BLUE}/officechair.png`,
  shelf: `${BLUE}/shelf.png`,
  filecabinet: `${BLUE}/filecabinet.png`,
  doccabinet: `${BLUE}/doccabinet.png`,
  partition: `${BLUE}/partition.png`,
  safe: `${BLUE}/safe.png`,
  serverrack: `${BLUE}/serverrack.png`,
  draftingtable: `${BLUE}/draftingtable.png`,
  whiteboard: `${BLUE}/whiteboard.png`,
  meetingtable: `${BLUE}/meetingtable.png`,
  officehutch: `${BLUE}/officehutch.png`,
  podium: `${BLUE}/podium.png`,
  servicecart: `${BLUE}/servicecart.png`,
  treadmill: `${BLUE}/treadmill.png`,
  elliptical: `${BLUE}/elliptical.png`,
  bike2: `${BLUE}/bike2.png`,
  spinbike: `${BLUE}/spinbike.png`,
  rowing: `${BLUE}/rowing.png`,
  fitness: `${BLUE}/fitness.png`,
  squatrack: `${BLUE}/squatrack.png`,
  benchpress: `${BLUE}/benchpress.png`,
  dumbbell: `${BLUE}/dumbbell.png`,
  inversion: `${BLUE}/inversion.png`,
  pilates: `${BLUE}/pilates.png`,
  massagebed: `${BLUE}/massagebed.png`,
  massagetable: `${BLUE}/massagetable.png`,
  sauna: `${BLUE}/sauna.png`,
  camping: `${BLUE}/camping.png`,
  pooltable: `${BLUE}/pooltable.png`,
  pingpong: `${BLUE}/pingpong.png`,
  airhockey: `${BLUE}/airhockey.png`,
  foosball: `${BLUE}/foosball.png`,
  golf: `${BLUE}/golf.png`,
  vacuum: `${BLUE}/vacuum.png`,
  robotvac: `${BLUE}/robotvac.png`,
  wetvac: `${BLUE}/wetvac.png`,
  dehumid: `${BLUE}/dehumid.png`,
  humid: `${BLUE}/humid.png`,
  heater: `${BLUE}/heater.png`,
  oilheater: `${BLUE}/oilheater.png`,
  fan: `${BLUE}/fan.png`,
  towerfan: `${BLUE}/towerfan.png`,
  ceilingfan: `${BLUE}/ceilingfan.png`,
  portableac: `${BLUE}/portableac.png`,
  steamcleaner: `${BLUE}/steamcleaner.png`,
  steamer: `${BLUE}/steamer.png`,
  drying: `${BLUE}/drying.png`,
  disposer: `${BLUE}/disposer.png`,
  standmixer: `${BLUE}/standmixer.png`,
  coffee: `${BLUE}/coffee.png`,
  microwave: `${BLUE}/microwave.png`,
  riceCooker: `${BLUE}/riceCooker.png`,
  icemaker: `${BLUE}/icemaker.png`,
  bigcabinet: `${BLUE}/bigcabinet.png`,
  cabinet2: `${BLUE}/cabinet2.png`,
  outdoorcabinet: `${BLUE}/outdoorcabinet.png`,
  storagebench: `${BLUE}/storagebench.png`,
  anglerack: `${BLUE}/anglerack.png`,
  toolbox: `${BLUE}/toolbox.png`,
  toolcart: `${BLUE}/toolcart.png`,
  bikestand: `${BLUE}/bikestand.png`,
  shoeopenrack: `${BLUE}/shoeopenrack.png`,
  entrybench: `${BLUE}/entrybench.png`,
  mirrorcabinet: `${BLUE}/mirrorcabinet.png`,
  foldscreen: `${BLUE}/foldscreen.png`,
  laundrycabinet: `${BLUE}/laundrycabinet.png`,
  washbasin: `${BLUE}/washbasin.png`,
  bathcabinet: `${BLUE}/bathcabinet.png`,
  bathvanity: `${BLUE}/bathvanity.png`,
  bathvanity2: `${BLUE}/bathvanity2.png`,
  bathtub: `${BLUE}/bathtub.png`,
  showcasefridge: `${BLUE}/showcasefridge.png`,
  chestfreezer: `${BLUE}/chestfreezer.png`,
  beveragefridge: `${BLUE}/beveragefridge.png`,
  bizdishwasher: `${BLUE}/bizdishwasher.png`,
  convectionoven: `${BLUE}/convectionoven.png`,
  deckoven: `${BLUE}/deckoven.png`,
  bizgasrange: `${BLUE}/bizgasrange.png`,
  rangehood: `${BLUE}/rangehood.png`,
  vending: `${BLUE}/vending.png`,
  waterdispenser: `${BLUE}/waterdispenser.png`,
  bizwasher: `${BLUE}/bizwasher.png`,
  bizdryer: `${BLUE}/bizdryer.png`,
  medbed: `${BLUE}/medbed.png`,
  salonchair: `${BLUE}/salonchair.png`,
  shampoochair: `${BLUE}/shampoochair.png`,
  aquarium: `${BLUE}/aquarium.png`,
  antiquecabinet: `${BLUE}/antiquecabinet.png`,
});
