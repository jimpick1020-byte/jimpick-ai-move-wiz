          ...
          >
            ...
            {iconGen && (
              <div className="fixed inset-0 z-[60] flex items-end justify-center">
                ...
                />
                <div className="relative h-full w-full overflow-y-auto overscroll-contain bg-gradient-to-b from-white to-[#F7F8F5] p-5 pb-[max(1rem,env(safe-area-inset-bottom))]">
